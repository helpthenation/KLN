...
class sale_register_summary(osv.osv_memory):
    ...
    _columns = {
        ...
        'partner_ids':fields.many2many('res.partner', 'partner_report_sale1', 'rep_id', 'partner_id', 'Customer'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_sale_register', data=data, context=context)
