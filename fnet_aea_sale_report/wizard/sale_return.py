...
class sale_return_summary(osv.osv_memory):
    _name = 'sale.return.summary'
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_sale_return', data=data, context=context)
