...
class product_wise_sales_summary(osv.osv_memory):
    _name = 'product.wise.sales.summary'
    ...
    _columns = {
        ...
        'company_ids':fields.many2many('res.company', 'company_report_product_sale', 'sale_id', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_product_wise_sales', data=data, context=context)
    ...
    def wiz_print_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['landscape','from_date', 'to_date','company_id','company_ids'], context=context)[0]
