...
class library_registratin(models.Model):
    ...
    def create(self, cr, uid, values, context=None):
        if values.get('card_no', _('Registration no')) == _('Registration no'):
            ...
            print'VVVVVVVVVVVVVVVVVVVVVVVVVvv',values
