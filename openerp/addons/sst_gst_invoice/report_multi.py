...
class ParticularReport(models.AbstractModel):
    ...
    _name = 'report.sst_gst_invoice.report_invoices'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('sst_gst_invoice.report_invoices')
        ...
        #_amount_to_text = self.env['account.voucher']._amount_to_text(amount, currency_id)
            ...
            return report_obj.render('sst_gst_invoice.report_invoices', docargs)
