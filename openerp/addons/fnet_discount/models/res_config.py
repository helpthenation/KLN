...
class sale_configuration(osv.osv_memory):
    ...
    'group_discount_global':fields.related('company_id' , 'group_discount_global', type='boolean',string="Allow setting a discount on the sales order Total Amount",
    ...
    def get_default_company_values(self, fields):
        ...
        return {
            'group_discount_global': company.group_discount_global,
    ...
    def set_company_values(self):
        company = self.env.user.company_id
        company.group_discount_global = self.group_discount_global
    ...
    def onchange_company_id(self, cr, uid, ids, company_id, context=None):
        ...
        company = self.pool.get('res.company').browse(cr, uid, company_id,
                                                      context=context)
        res['value']['group_discount_global'] = company.group_discount_global
