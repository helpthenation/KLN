...
class sale_quotation_line_make_order(osv.osv_memory):
    _name = "sale.quotation.line.make.order"
    _description = "Sale Quotation Line Make_Order"
    ...
    def make_invoices(self, cr, uid, ids, context=None):
        ...
        sale_obj=sales_order_obj.browse(cr,uid,get_id[0])
