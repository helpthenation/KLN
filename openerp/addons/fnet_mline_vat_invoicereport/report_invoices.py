...
class ParticularReport(models.AbstractModel):
    _name = 'report.fnet_mline_vat_invoicereport.report_invoices' 
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('fnet_mline_vat_invoicereport.report_invoices')
        ...
        for order in stock_pick.browse(self.ids):
            ...
            return report_obj.render('fnet_mline_vat_invoicereport.report_invoices', docargs)
