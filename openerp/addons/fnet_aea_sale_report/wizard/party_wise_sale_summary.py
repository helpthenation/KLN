...
class party_wise_sale_summary(osv.osv_memory):
    ...
    _columns = {
        ...
        'partner_ids':fields.many2many('res.partner', 'partner_report_party_wise_sale', 'rep_id', 'partner_id', 'Supplier'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_party_wise_sale_summary', data=data, context=context)
