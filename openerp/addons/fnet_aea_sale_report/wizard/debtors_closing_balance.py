...
class debtors_closing_balance(osv.osv_memory):
    _name = 'debtors.closing.balance'
    ...
    _description = 'Debtors closing balance'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'from_date': fields.date('From Date', required=True),
        'company_ids':fields.many2many('res.company', 'company_report_debto', 'stock_id1', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_debtors_closing_balance', data=data, context=context)
