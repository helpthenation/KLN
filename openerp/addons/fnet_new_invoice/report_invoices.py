...
class ParticularReport(models.AbstractModel):
    ...
    _name = 'report.fnet_new_invoice.report_invoices'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('fnet_new_invoice.report_invoices')
        ...
        return report_obj.render('fnet_new_invoice.report_invoices', docargs)
