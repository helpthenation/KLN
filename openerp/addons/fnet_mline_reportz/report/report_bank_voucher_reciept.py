...
class ParticularReport(osv.AbstractModel):
    _name = 'report.fnet_mline_reportz.report_bank_voucher_reciept'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('fnet_mline_reportz.report_bank_voucher_reciept')
        ...
        return report_obj.render('fnet_mline_reportz.report_bank_voucher_reciept', docargs)                                                                                                                                                        
