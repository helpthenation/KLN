...
class ParticularReport(osv.AbstractModel):
    _name = 'report.fnet_mline_reportz.check_writing'
    ...
    def render_html(self,data=None):
        ...
        report = report_obj._get_report_from_name('fnet_mline_reportz.check_writing')
        ...
        if account_move.journal_id.code in ("cbd,nbf"):
            ...
            return report_obj.render('fnet_mline_reportz.check_writing', docargs)
        else:
