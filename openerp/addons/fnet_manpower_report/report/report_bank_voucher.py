...
class ParticularReport(osv.AbstractModel):
    _name = 'report.fnet_manpower_report.report_bank_voucher'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('fnet_manpower_report.report_bank_voucher')
        bank_obj=self.env['account.move'].search([('id','=',self.id)])
        docargs = {
            'doc_ids': bank_obj,
            'doc_model': report.model,
            'docs': self,
        }
        return report_obj.render('fnet_manpower_report.report_bank_voucher', docargs)                                                                                                                                                        
