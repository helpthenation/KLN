...
class ParticularReport(osv.AbstractModel):
    _name = 'report.fnet_manpower_report.report_reciept_voucher'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('fnet_manpower_report.report_reciept_voucher')
        ...
        return report_obj.render('fnet_manpower_report.report_reciept_voucher', docargs)                                                                                                                                                        
