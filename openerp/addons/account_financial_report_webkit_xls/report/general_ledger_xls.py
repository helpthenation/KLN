...
class general_ledger_xls(report_xls):
    ...
    def generate_xls_report(self, _p, _xs, data, objects, wb):
        print'_______________________________________p',_p
        print'______________________________________XS',_xs
        print'______________________________________data',data
        print'______________________________________objects',objects
        print'______________________________________wb',wb
        
        ws = wb.add_sheet(_p.report_name[:31])
        print'______________________________________ws',ws
        ...
        print'____________________________________CSPECS',c_specs
        row_data = self.xls_row_template(c_specs, [x[0] for x in c_specs])
        print'__________________________________________row',row_data
        row_pos = self.xls_write_row(
            ws, row_pos, row_data, row_style=cell_style_center)
        print'__________________________________________row_pos',row_pos
        ...
        print'____________________CSPEC2',c_specs
        df = _('From') + ': '       
        ...
        print'____________________DF',df
        c_specs += [
            ('df', 3, 0, 'text', df),
        ...
        print'_______________________________________CSPEC3',c_specs
        row_data = self.xls_row_template(c_specs, [x[0] for x in c_specs])
        print'__________________________________ROW DATA 2',row_data
        row_pos = self.xls_write_row(
            ws, row_pos, row_data, row_style=cell_style_center)
        print'______________________________ROW POS 2',row_pos    
        ...
        print'______________________________________________CSPEC4',c_specs
        ...
        for account in objects:
            ...
            print'_____________________________________display_initial_balance',display_initial_balance
            print'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~display_ledger_lines',display_ledger_lines
