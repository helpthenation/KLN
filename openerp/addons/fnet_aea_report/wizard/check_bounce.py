...
class check_bounce_rep(osv.osv_memory):
    _name = 'check.bounce.rep'
    ...
    _description = 'Cheque Bounce Details Reports'
    _columns = {
        'cus_type': fields.selection([('customer', 'Customer'),('supplier', 'Supplier')], 'Type', required=True),
        'district_ids':fields.many2many('res.country.district', 'district_report_rel1', 'rep_id', 'district_id', 'District'),
        'partner_ids':fields.many2many('res.partner', 'partner_report_rel1', 'rep_id', 'partner_id', 'Customer'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_report.report_cheque_bounce', data=data, context=context)
