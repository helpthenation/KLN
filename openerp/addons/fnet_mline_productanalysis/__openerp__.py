...
##############################################################################
{
    'name': "Fnet Product Master Analysis",
    'version': '8.0.1.0.0',
    'category': 'Reporting',
        'description': """
			This module contains pivot view to analysis the sale price, margin price, purchase price of a product.
                   """,
    'author': 'Futurenet',
    'website': 'http://www.futurenet.in/',
    'license': 'AGPL-3',
    "depends": [
        'crm','sale','purchase','product'
    ],
    "data":[
    'security/product_security.xml',
    'security/ir.model.access.csv',
    'product_analysis_report_view.xml',],
