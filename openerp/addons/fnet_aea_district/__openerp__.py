...
##############################################################################
{
    'name': "Adding District Field In Account Invoice",
    'version': '8.0.1.0.0',
    'category': 'Accounting',
        'description': """
			This Module will add a field namely district in account invoice which is used to view invoiced details in pivot view based on Territory.
                   """,
    'author': 'Futurenet',
