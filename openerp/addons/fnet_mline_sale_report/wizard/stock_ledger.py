...
class stock_ledger_summary(osv.osv_memory):
    ...
    _columns = {
        ...
        'partner_ids':fields.many2many('res.partner', 'partner_report_stock_ledger', 'stock_id', 'partner_id', 'Customer'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_stock_ledger', data=data, context=context)
