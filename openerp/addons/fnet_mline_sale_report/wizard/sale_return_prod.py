...
class sale_register_product1(osv.osv_memory):
    _name = 'sale.register.product1'
    ...
    _description = 'Sales Return Product'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'from_date': fields.date('From Date', required=True),
        'partner_ids':fields.many2many('res.partner', 'partner_report_sale3', 'rep_id', 'partner_id', 'Customer'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_sale_product1', data=data, context=context)
