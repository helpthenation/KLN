...
class purchase_register_consolidate(osv.osv_memory):
    _name = 'purchase.register.consolidate'
    ...
    _description = 'Purchase Register Consolidate'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'from_date': fields.date('From Date', required=True),
        'partner_ids':fields.many2many('res.partner', 'partner_report_purchase_consolidate', 'rep_id', 'partner_id', 'Supplier'),
        'company_ids':fields.many2many('res.company', 'company_report_purchase_consolidate', 'stock_id1', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_purchase_register_consolidate', data=data, context=context)
