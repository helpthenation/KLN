...
class salary_summary(osv.osv_memory):
    ...
    _columns = {
        ...
        'employee_ids':fields.many2many('hr.employee', 'partner_report_salary_summary', 'rep_id', 'employee_id', 'Employee'),
        'company_ids':fields.many2many('res.company', 'company_report_salary_summary', 'stock_id1', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_salary_summary', data=data, context=context)
    ...
    def wiz_print_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['landscape','from_date', 'to_date','employee_ids','company_ids'], context=context)[0]
        data['form'].update(self.read(cr, uid, ids, ['landscape'])[0])
        for field in ['employee_ids']:
