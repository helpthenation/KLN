...
class purchase_register_summary(osv.osv_memory):
    _name = 'purchase.register.summary'
    ...
    _description = 'Sales Return Summary'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'from_date': fields.date('From Date', required=True),
        'partner_ids':fields.many2many('res.partner', 'partner_report_purchase', 'rep_id', 'partner_id', 'Supplier'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_purchase_register', data=data, context=context)
