...
class sale_summary_month_wise(osv.osv_memory):
    _name = 'sale.summary.month.wise'
    ...
    _description = 'Sales Summary Month Wise'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'period_id':fields.many2one('account.period','Period',required=True),
        'partner_ids':fields.many2many('res.partner', 'partner_report_sale_summary_mw', 'rep_id', 'partner_id', 'Supplier'),
        'company_ids':fields.many2many('res.company', 'company_report_sale_summary_mw', 'stock_id', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_sale_summary_month_wise', data=data, context=context)
    ...
    def wiz_print_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['landscape','period_id','partner_ids','company_ids'], context=context)[0]
