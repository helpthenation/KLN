...
class sale_register_summary(osv.osv_memory):
    _name = 'sale.register.pending'
    ...
    _description = 'Pending Sales Register'
    _columns = {
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_sale_register_pending', data=data, context=context)
    ...
    def wiz_print_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['landscape','from_date', 'to_date','company_id'], context=context)[0]
