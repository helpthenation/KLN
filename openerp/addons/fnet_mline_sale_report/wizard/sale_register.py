...
class sale_register_summary(osv.osv_memory):
    ...
    _description = 'Sales Register Summary'
    _columns = {
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_sale_register', data=data, context=context)
