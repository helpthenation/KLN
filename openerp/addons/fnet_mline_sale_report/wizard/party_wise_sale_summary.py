...
class party_wise_sale_summary(osv.osv_memory):
    _name = 'party.wise.sale.summary'
    ...
    _description = 'Party Wise Sales Summary'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'from_date': fields.date('From Date', required=True),
        'partner_ids':fields.many2many('res.partner', 'partner_report_party_wise_sale', 'rep_id', 'partner_id', 'Customer'),
        'company_ids':fields.many2many('res.company', 'company_report_party_wise_sale', 'stock_id1', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_mline_sale_report.report_party_wise_sale_summary', data=data, context=context)
