...
class po_return_report(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(po_return_report, self).__init__(cr, uid, name, context)
...
class wrapped_po_return_summary(osv.AbstractModel):
    _name = 'report.fnet_mline_sale_report.report_po_return'
    _inherit = 'report.abstract_report'
    _template = 'fnet_mline_sale_report.report_po_return'
    _wrapped_report_class = po_return_report
