...
class sale_register_pending_report(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(sale_register_pending_report, self).__init__(cr, uid, name, context)
...
class wrapped_sale_register_pending(osv.AbstractModel):
    _name = 'report.fnet_mline_sale_report.report_sale_register_pending'
    _inherit = 'report.abstract_report'
    _template = 'fnet_mline_sale_report.report_sale_register_pending'
    _wrapped_report_class = sale_register_pending_report
