...
class ParticularReport(models.AbstractModel):
    ...
    _name = 'report.fnet_aea_journal_report.report_debit_move'
    ...
    def render_html(self, data=None):
        ...
        report = report_obj._get_report_from_name('fnet_aea_journal_report.report_debit_move')
        ...
        return report_obj.render('fnet_aea_journal_report.report_debit_move', docargs)
