...
class accounting_report(osv.osv_memory):
    ...
    def _get_company_report(self, cr, uid, context=None):
        print "222222222222222222",self.pool.get("res.company").search(cr,uid,[])
        cmpids = self.pool.get("res.company").search(cr,uid,[])
        return cmpids and cmpids[0] or False
    ...
    _defaults = {
            ...
            'company_id': _get_company_report,
    }
