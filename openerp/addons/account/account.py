...
class account_move(osv.osv):
    ...
    def post(self, cr, uid, ids, context=None):
        ...
        print'POSTPOSTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT',valid_moves
        if not valid_moves:
    ...
    def validate(self, cr, uid, ids, context=None):
        print'FFFFFFFFFFFFFFFFFFFFFFFFFFFF',ids
        ...
        print'VALID MOVEEEEEEEEEEEEEEEEEEEEEEEEEE',valid_moves
