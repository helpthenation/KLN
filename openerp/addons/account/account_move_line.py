...
class account_move_line(osv.osv):
    ...
    def reconcile(self, cr, uid, ids, type='auto', writeoff_acc_id=False, writeoff_period_id=False, writeoff_journal_id=False, context=None):
        ...
        currency_obj = self.pool.get('res.currency')
        lines = self.browse(cr, uid, ids, context=context)
        print'linesssssssssssssssssss',ids
        print'linesssssssssssssssssss',lines
        unrec_lines = filter(lambda x: not x['reconcile_id'], lines)
        print'DDDDDDDDDDDDDDDDDDDD',unrec_lines
        credit = debit = 0.0
        currency = 0.0
        account_id = False
        partner_id = False
        ...
        print'debitdebitdebitdebitdebit',   debit 
        print'creditcreditcreditcredit',   credit 
        writeoff = debit - credit

        print'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF',   writeoff 
        ...
        # to revalidate their moves completely.
        reconcile_context = dict(context, novalidate=True)
        print'reconcile_contextreconcile_contextreconcile_contextreconcile_contextreconcile_context',reconcile_context
