...
class third_party_ledger(report_sxw.rml_parse, common_report_header):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        print'INITQUERY****************',self.init_query
        self.reconcil = True
        if data['form']['filter'] == 'unreconciled':
            self.reconcil = False
        ...
        print'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF',self.account_ids
        ...
        print'OBJECTSSSSSSSSSSSSSSSSSSSSSSS',objects
    ...
    def lines(self, partner):
        ...
        print'RECONCILE_TAG',RECONCILE_TAG
        print'SELFQUERYYYYYYYYYYYYYYYYYYYYY',self.query
        self.cr.execute(
        ...
        print'FULLL ACCOUNTTTTT',    full_account
        return full_account
