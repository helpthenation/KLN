...
class consolidated_tb_report(osv.osv_memory):
    _name = "consolidated.tb.report"
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(consolidated_tb_report, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=False)
    ...
    def _build_contexts(self, cr, uid, ids, data, context=None):
        if context is None:
            context = {}
        result = {}
        #~ print'DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD','chart_account_id' in data['form'] and data['form']['chart_account_id']

        result['fiscalyear'] = 'fiscalyear_id' in data['form'] and data['form']['fiscalyear_id'] or False
        result['journal_ids'] = 'journal_ids' in data['form'] and data['form']['journal_ids'] or False
        result['chart_account_id'] = 'chart_account_id' in data['form'] and data['form']['chart_account_id'] or False
        result['state'] = 'target_move' in data['form'] and data['form']['target_move'] or ''
        result['display_account'] = 'display_account' in data['form'] and data['form']['display_account'] or ''
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        context = context or {}       
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_consolidated_trial_balance.report_consolidated_trialbalance', data=data, context=context)
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['display_account','date_from',  'date_to',  'fiscalyear_id', 'journal_ids', 'period_from', 'period_to',  'filter',  'chart_account_id', 'target_move'], context=context)[0]
        ...
        print "222222222222222ll",uid,ids
