...
class stock_summary(osv.osv_memory):
    _name = 'stock.summary.apex'
    ...
    _description = 'Consolidated Stock Summary'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'company_ids':fields.many2many('res.company', 'company_report_stock_summary_apex', 'stock_id', 'company_id1', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_apex_stock_summary.report_stock_ledger2', data=data, context=context)
    ...
    def wiz_print_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['landscape','from_date','company_ids'], context=context)[0]
