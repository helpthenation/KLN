...
class fnet_aged_trial_report(report_sxw.rml_parse,common_report_header):
    ...
    def _get_customer(self,data, sales_id):
        ...
        if len(where_sql) < 1:
            where_sql=''
        print where_sql,'*********'
        self.cr.execute("""SELECT distinct rp.id as id,rp.name as partner 
                        FROM account_invoice ai 
                        JOIN res_partner rp ON (rp.id = ai.partner_id) 
                        JOIN res_company rc ON (rc.id = ai.company_id)"""
                        + str(where_sql[0]) +
    ...
    def _get_aged_value(self,data, sales_id,partner_id):
        ...
        self.cr.execute("""SELECT branch,
                            ...
                            GROUP BY branch,partner,salesperson""", (data['form']['date_from'],data['form']['4']['start'],data['form']['4']['stop'],data['form']['3']['start'],data['form']['3']['stop'],data['form']['2']['start'],data['form']['2']['stop'],data['form']['1']['start'],data['form']['1']['stop'],data['form']['0']['stop'],data['form']['date_from'],tuple(move_state),tuple(type_in),data['form']['company_id'][0],data['form']['date_from'],sales_id,partner_id))
        partners = self.cr.dictfetchall()
        return partners
    ...
    def _get_lines(self,data,sales_id,partner_id):
        ...
        self.cr.execute("""SELECT branch,partner,date_invoice,number,salesperson,not_due,days,
                        ...
                        ai.company_id= %s and ai.date_invoice <= %s and rpu.id = %s and rp.id= %s 
                        GROUP BY rc.name,rp.name,rpu.name,ai.number,ai.id,ai.date_invoice,ai.date_due ORDER BY 1,2)temp
                        GROUP BY branch,partner,date_invoice,number,salesperson,not_due,days""",(data['form']['date_from'],data['form']['4']['start'],data['form']['4']['stop'],data['form']['3']['start'],data['form']['3']['stop'],data['form']['2']['start'],data['form']['2']['stop'],data['form']['1']['start'],data['form']['1']['stop'],data['form']['0']['stop'],data['form']['date_from'],tuple(move_state),tuple(type_in),data['form']['company_id'][0],data['form']['date_from'],sales_id,partner_id))
        partners = self.cr.dictfetchall()
        return partners
    ...
    def _get_total(self,data):
        ...
        self.cr.execute("""SELECT branch,
                        ...
                        GROUP BY branch""",(data['form']['date_from'],data['form']['4']['start'],data['form']['4']['stop'],data['form']['3']['start'],data['form']['3']['stop'],data['form']['2']['start'],data['form']['2']['stop'],data['form']['1']['start'],data['form']['1']['stop'],data['form']['0']['stop'],data['form']['date_from'],tuple(move_state),tuple(type_in),data['form']['company_id'][0],data['form']['date_from']))
        partners = self.cr.dictfetchall()
        return partners
