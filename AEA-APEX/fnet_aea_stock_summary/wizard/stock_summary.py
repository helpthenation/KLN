...
class stock_summary(osv.osv_memory):
    ...
    _columns = {
        ...
        'company_ids':fields.many2many('res.company', 'company_report_stock_summary', 'stock_id', 'company_id1', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_stock_summary.report_stock_summary', data=data, context=context)
