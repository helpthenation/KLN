...
class consolidated_sales_apex(osv.osv_memory):
    _name = 'consolidated.sales.apex'
    ...
    _columns = {
        ...
        'company_ids':fields.many2many('res.company', 'company_report_consolidated_sale_apex', 'sale_id', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_apex_consolidated_sale.report_consolidated_sales_apex', data=data, context=context)
