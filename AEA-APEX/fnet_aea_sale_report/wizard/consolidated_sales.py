...
class consolidated_sales(osv.osv_memory):
    _name = 'consolidated.sales'
    ...
    _columns = {
        ...
        'company_ids':fields.many2many('res.company', 'company_report_consolidated_sale', 'sale_id', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_consolidated_sales', data=data, context=context)
