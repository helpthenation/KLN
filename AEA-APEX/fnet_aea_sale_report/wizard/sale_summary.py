...
class sale_summary(osv.osv_memory):
    ...
    _columns = {
        ...
        'partner_ids':fields.many2many('res.partner', 'partner_report_sale_summary', 'rep_id', 'partner_id', 'Supplier'),
        'company_ids':fields.many2many('res.company', 'company_report_sale_summary', 'stock_id1', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_sale_summary', data=data, context=context)
