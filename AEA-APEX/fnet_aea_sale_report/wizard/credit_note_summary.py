...
class credit_note_summary(osv.osv_memory):
    _name = 'credit.note.summary'
    ...
    _description = 'Credit Note Summary'
    _columns = {
        'company_id': fields.many2one('res.company', 'Company'),
        'from_date': fields.date('From Date', required=True),
        'company_ids':fields.many2many('res.company', 'company_report_credit_note', 'stock_id1', 'company_id', 'Company'),
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        return self.pool['report'].get_action(cr, uid, [], 'fnet_aea_sale_report.report_credit_note_summary', data=data, context=context)
